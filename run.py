...
# df_NCCC_1 = pd.read_csv('src/data/runs_file_NCCC_LHC.csv', index_col=0)
...
df_NCCC_full = pd.read_csv(
    r'C:\Users\Tanner\Documents\git\MEA-Absorption-Column\src\mea_absorption_column\data\C_cases_data.csv', index_col=0)
