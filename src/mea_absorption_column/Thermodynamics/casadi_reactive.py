...
class EnginePhase:
    ...
    def __init__(self, name, mapping, thermochemistry, *, kind, feed_ids=None, molar_masses=None,
        ...
        # Separate callbacks keep Jacobians of H-free, inlined graph slices from requesting enthalpy
        # actions; an unavailable action (e.g. caloric second order) refuses, typed and without a value.
