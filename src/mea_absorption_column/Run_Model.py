...
def run_model(df,
    ...
    model_options = {
        ...
        'wall_heat_loss_coeff_W_m_K': float(solver_settings_for_run.get('wall_heat_loss_coeff_W_m_K', 0.0) or 0.0),
        'ambient_temperature_K': float(solver_settings_for_run.get('ambient_temperature_K', 298.15)),
