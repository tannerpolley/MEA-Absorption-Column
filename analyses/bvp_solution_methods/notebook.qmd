...
resolution with a matched retained-profile initialization, then refine film
quadrature separately. Three initializations remain required before making any
branch claim. Other selected solution methods and matched achieved-accuracy
costs remain later work.
...
setup failure. The source record for the
