...
Candidate A, `{config['candidate_A']['id']}`, is **blocked** because all nine source-complete effective diffusivities or a cited source-defined lump are unavailable, and the concentration basis is unresolved. Candidate B, `{config['candidate_B']['id']}`, is **blocked** because its complete mobility law, unequal-ion inputs, ePC-SAFT Gamma, and admitted true-species state are unavailable. Scalar diffusivities are not converted into a mobility matrix.
