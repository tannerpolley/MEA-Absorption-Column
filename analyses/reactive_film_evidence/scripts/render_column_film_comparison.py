...
def main() -> None:
    ...
    capture.scatter(x, data["film_capture_pct"], marker="s", s=42, color="#CC6677", label="Reactive film")
    ...
    change.scatter(x, delta, marker="s", s=42, color="#CC6677")
    ...
    fig.suptitle("Reactive-film closure changes the predicted capture campaign")
    fig.tight_layout()
