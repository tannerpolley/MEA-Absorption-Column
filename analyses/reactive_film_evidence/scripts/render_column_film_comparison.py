...
def main() -> None:
    ...
    capture.scatter(data.index[~converged], data.loc[~converged, "film_capture_pct"], marker="s", s=42, facecolors="none", edgecolors="#CC6677", label="_nolegend_" if converged.all() else "Film (outer limit)")
    ...
    fig.text(0.5, 0.955, "Estimated ionic mobility; reactive bulk fugacity and conductance both change", ha="center", fontsize=9)
