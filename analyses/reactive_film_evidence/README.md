...
All eight packed-column solves satisfy their boundary conditions at numerical precision. Four cases (K19, 1C, 4C, and 6C) also meet the declared outer-film stopping rule: less than 0.05 percentage-point capture change and less than 2% maximum change in both the interpolated conductance and reactive bulk-fugacity fields. K18, 2C, 3C, and 5C reach the common nine-update cap first and remain explicitly marked provisional/non-field-converged in the aggregate and figure. **[verified]**
