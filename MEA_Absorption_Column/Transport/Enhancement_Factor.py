...
def enhancement_factor(Tl, y_CO2, P, Cl_true,
    ...
    k_MEA = 3.1732e3 * exp(-4936.6 / Tl)
    k_H2O = 1.0882e2 * exp(-3900 / Tl)
    k2 = (k_MEA * Cl_MEA_true + k_H2O * Cl_true[2]) # Pseudo Second Order from IDAES
    ...
    enhance_factor = [k2, Ha, E, Ψ]

    return Ψ, enhance_factor
