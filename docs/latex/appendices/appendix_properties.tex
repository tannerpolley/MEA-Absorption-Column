    ...
    \section{Properties}\label{sec:properties}
        ...
        \subsection{Thermophysical Properties}
            ...
            \subsubsection{Henry's Law} 
                Henry's Law for the liquid solvent mixture is formulated with the N$_2$O analogy. The expressions used for $\COtwo$ solubility in $\MEA$ follow Jiru et al. \cite{Jiru2012}:
                \begin{align}
            ...
            \subsubsection{Enthalpy}
                The correlations are adapted from Akula \cite{Akula2023} for the present absorber model
                \begin{align}
        ...
        \subsection{Transport Properties}
            \subsubsection{Viscosity} \cite{Morgan2015}
                ...
                \begin{align}
                    ...
                    && \text{dimensionless correlation term}\\
